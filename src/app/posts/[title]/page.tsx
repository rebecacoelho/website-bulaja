...
import Post1 from '../../../../public/medicamentos.jpeg'
import Post2 from '../../../../public/aspirina.jpeg'
import '../../globals.css'
...
const posts = [
  ...
  {
    title: "Evolução nos medicamentos",
    image: Post2,
    ...
    <div className="bg-white">
      <div className='container'>
        ...
        <div className='bg-blue-300 py-4 pb-8 rounded-md'>
          ...
          <div className='flex flex-col gap-2 text-center mt-4 mx-4'>
            <p className='font-normal text-lg'>{post.description}</p>
          </div>
          <div className='mt-6 flex justify-center text-center mx-4'>
